...
export default function CalcInfo({tokenSwapped, swappedValue}:any){
    return (
      <div className="bg-transparent mt-4 space-y-2 px-4 py-2 rounded-lg">
        ...
        <div className="text-xs text-gray-400 flex flex-row items-center justify-between">
          ...
          <div className="text-right">
            <span className="text-[#ecf5ff]">{swappedValue.value}</span>&nbsp;{swappedValue.name}
          </div>
        </div>
        ...
        <div className="text-xs text-gray-400 flex flex-row items-center justify-between">
          ...
          </div>
          {
              ...
              <div className="text-right flex flex-row gap-1 items-center">
                <div className="bg-[#abc4ff12] rounded-full"><img src='/raydium/usdt.png' className="w-[14px] h-[14px] m-1"/></div>
                <span className="text-[10px]">0.05% ▸</span>
                <div className="bg-[#abc4ff12] rounded-full"><img src='/raydium/usdc.png' className="w-[14px] h-[14px] m-1"/></div>
                <span className="text-[10px]">0.01% ▸</span>
                <div className="bg-[#abc4ff12] rounded-full"><img src='/raydium/solana.png' className="w-[14px] h-[14px] m-1"/></div>
            </div>:
              <div className="text-right flex flex-row gap-1 items-center">
                <div className="bg-[#abc4ff12] rounded-full"><img src='/raydium/solana.png' className="w-[14px] h-[14px] m-1"/></div>
                <span className="text-[10px]">0.05% ▸</span>
        ...
        <div className="flex flex-row justify-center gap-1items-center text-[10px] text-gray-400">
          <span>Less info</span>
          <CaretUp/>
        </div>
      </div>
